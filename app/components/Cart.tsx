...
const Cart: React.FC = () => {
  ...
  return (
    <aside className={`${cartItems.length === 0 || !CartOpen ? 'hidden' : 'hidden md:flex'} md:flex-col md:sticky md:top-0 md:self-start md:h-screen w-[420px] bg-white shadow-2xl z-50`}>
