...
export const LoginModal: React.FC = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-md bg-accents border-border overflow-hidden p-0">
          ...
          <div className="space-y-6 mt-8">
            {!isEmployee ? session ? null:(
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button 
                  variant="outline" 
                  className="font-sifonn border-border hover:bg-accent/80 transition-all duration-300 cursor-pointer"
                ...
                <Button 
                  variant="outline"
                  className="font-sifonn border-border hover:bg-accent/80 transition-all duration-300"
                >
